...
#
#  $ bin/test -s sayka.content -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src sayka.content.testing.SAYKA_CONTENT_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/sayka/content/tests/robot/test_example.robot
#
